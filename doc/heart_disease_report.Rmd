...
Here, we make some clarification about some variables related to EDA.
    <ul>
      <li>cp: chest pain type with four different types:
        0: asymptomatic,
        1: atypical angina,
        2: non-anginal pain,
        3: typical angina</li>
      <li>trestbps: resting blood pressure</li>
      <li>chol: the amount of serum cholestoral in the blood</li>
      <li>thalach: Maximum heart rate achieved</li>
      <li>exang: Exercise-induced angina,which is chest pain that occurs during or after physical activity. It has two types: no exercise-induced angina(0) versus existing exercise-induced angina(1)</li>
      <li>oldpeak: ST depression induced by exercise relative to rest</li>
      <li>slope: Slope of the peak exercise ST segment,which is related to the heart's electrical activity during exercise</li>
...
```{r fig.align='center'}
knitr::include_graphics("../results/EDA_results/numeric.jpg")
```
\n  
...
```{r fig.align='center'}
knitr::include_graphics("../results/EDA_results/categorical.jpg")
```
...
ci <- read.csv(here("results/analysis_results", "bootstrap_ci_results.csv"))
ci$target <- ifelse(ci$target ==0, "No heart disease", "Presence of heart disease")
num_res <- read.csv(here("results/analysis_results", "hypothesis_result.csv"))
cat_res <- read.csv(here("results/analysis_results", "chisq_result.csv"))
